...
describe('基础数据结构对象', () => {
  ...
  it('创建一个仓库档案，增删改仓库基础数据', async () => {
    ...
    const Warehouse = createModel(BaseData, 'Warehouse3', {
  ...
  it('创建一个仓库档案，并引用了人员和部门档案等信息', async () => {
    let eventbus = [];
    const Department = createModel(BaseData, "Department3", {
      "Code": "string",
      "Name": "string"
    })
    const Persion = createModel(BaseData, 'Persion3', {
      "Code": "string",
      "Status": 'bool',
      "Name": "string",
      "Shorthand": "string",
    ...
    const WarehouseType = createModel(BaseData, 'WarehouseType3', {
      "Code": "string",
      "Name": "string"
    });
    const Warehouse = createModel(BaseData, 'Warehouse4', {
      "Code": {
        type: "string",
        required: true // 必录
      }, // 字符串
