...
const entityTypes = exports.entityTypes = ['string', 'object', 'array', 'number', 'boolean', 'date', 'reference', 'function'];
const tableTypes = exports.tableTypes = ['string', 'object', 'array', 'number', 'boolean', 'date', 'reference', 'buffer', 'mixed', 'function'];
